      ...
      <div className="mx-auto max-w-6xl">
        <header className="flex flex-col gap-5 border-b border-[#d4e0d3]/20 pb-7 md:flex-row md:items-end md:justify-between">
          <div>
            ...
            <Link href="/subscribers" className="mt-4 inline-block font-mono text-xs uppercase tracking-[0.16em] text-[#9eff6b] transition hover:text-[#d4e0d3]">View subscribers →</Link>
          </div>
